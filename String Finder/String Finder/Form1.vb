Public Class Form1
    ...
    Private Sub btnGo_Click(sender As Object, e As EventArgs) Handles btnGo.Click
        ...
        Dim intStartIndex As Integer 'Starting index for search
        ...
        If IsNumeric(txtStartIndex.Text) Then
            ...
            If txtToFind.Text.Length > 0 Then
                ...
                'Indicate whether the search was found
                If intFoundIndex = -1 Then
                    lblResults.Text = "The string was not found"
                Else
                    lblResults.Text = "The string was found at index " & intFoundIndex.ToString()
                    '.toString() converts the integer to a string

                End If
            Else
                'Display an error message if no string to search for was entered.
